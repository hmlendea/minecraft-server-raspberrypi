...
export PURPUR_EXTRAS_CONFIG_FILE="${SERVER_ROOT_DIR}/plugins/PurpurExtras.yml"
...
export COREPROTECT_DIR="${SERVER_PLUGINS_DIR}/CoreProtect"
...
export INVUNLOAD_DIR="${SERVER_PLUGINS_DIR}/InvUnload"
export LUCKPERMS_DIR="${SERVER_PLUGINS_DIR}/LuckPerms"
export MINIMOTD_DIR="${SERVER_PLUGINS_DIR}/MiniMOTD"
export OLDCOMBATMECHANICS_DIR="${SERVER_PLUGINS_DIR}/OldCombatMechanics"
...
export SUPERBVOTE_DIR="${SERVER_PLUGINS_DIR}/SuperbVote"
...
export COREPROTECT_CONFIG_FILE="${COREPROTECT_DIR}/config.yml"
...
export INVUNLOAD_CONFIG_FILE="${INVUNLOAD_DIR}/config.yml"
export LUCKPERMS_CONFIG_FILE="${LUCKPERMS_DIR}/config.yml"
export OLDCOMBATMECHANICS_CONFIG_FILE="${OLDCOMBATMECHANICS_DIR}/config.yml"
export PAPERTWEAKS_CONFIG_FILE="${PAPERTWEAKS_DIR}/config.yml"
...
export SUPERBVOTE_CONFIG_FILE="${SUPERBVOTE_DIR}/config.yml"
export TRADESHOP_CONFIG_FILE="${TRADESHOP_DIR}/config.yml"
export TRADESHOP_MESSAGES_FILE="${TRADESHOP_DIR}/messages.yml"
export TREEASSIST_CONFIG_FILE="${TREEASSIST_DIR}/config.yml"
export VAULT_CONFIG_FILE="${VAULT_DIR}/config.yml"
...
export VOTINGPLUGIN_CONFIG_FILE="${VOTINGPLUGIN_DIR}/Config.yml"
export WANDERINGTRADES_CONFIG_FILE="${WANDERINGTRADES_DIR}/config.yml"
export WORLDEDIT_CONFIG_FILE="${WORLDEDIT_DIR}/config.yml"
export WORLDEDITSUI_CONFIG_FILE="${WORLDEDITSUI_DIR}/config.yml"
