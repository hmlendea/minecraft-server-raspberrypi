...
export VIEW_DISTANCE_VANILLA=10
...
export VIEW_DISTANCE_MAX=${VIEW_DISTANCE_VANILLA}
export VIEW_DISTANCE_PERCENTAGE_OF_VANILLA=$((100 * ${VIEW_DISTANCE} / ${VIEW_DISTANCE_VANILLA}))
...
export SIMULATION_DISTANCE_PERCENTAGE_OF_VANILLA=$((100 * ${SIMULATION_DISTANCE} / ${SIMULATION_DISTANCE_VANILLA}))
...
export MOB_SPAWN_LIMIT_MONSTERS=$((70 * ${SIMULATION_DISTANCE_PERCENTAGE_OF_VANILLA} / 100))
export MOB_SPAWN_LIMIT_ANIMALS=$((10 * ${SIMULATION_DISTANCE_PERCENTAGE_OF_VANILLA} / 100))
export MOB_SPAWN_LIMIT_WATER_ANIMALS=$((5 * ${SIMULATION_DISTANCE_PERCENTAGE_OF_VANILLA} / 100))
export MOB_SPAWN_LIMIT_WATER_AMBIENT=$((20 * ${SIMULATION_DISTANCE_PERCENTAGE_OF_VANILLA} / 100))
export MOB_SPAWN_LIMIT_WATER_UNDERGROUND_CREATURES=$((5 * ${SIMULATION_DISTANCE_PERCENTAGE_OF_VANILLA} / 100))
export MOB_SPAWN_LIMIT_AXOLOTLS=$((5 * ${SIMULATION_DISTANCE_PERCENTAGE_OF_VANILLA} / 100))
export MOB_SPAWN_LIMIT_AMBIENT=$((5 * ${SIMULATION_DISTANCE_PERCENTAGE_OF_VANILLA} / 100))

if [ ${SIMULATION_DISTANCE_PERCENTAGE_OF_VANILLA} -le 10 ]; then
    export MOB_SPAWN_RANGE=3
elif [ ${SIMULATION_DISTANCE_PERCENTAGE_OF_VANILLA} -le 35 ]; then
    export MOB_SPAWN_RANGE=4
elif [ ${SIMULATION_DISTANCE_PERCENTAGE_OF_VANILLA} -le 55 ]; then
    export MOB_SPAWN_RANGE=5
elif [ ${SIMULATION_DISTANCE_PERCENTAGE_OF_VANILLA} -le 75 ]; then
    export MOB_SPAWN_RANGE=6
elif [ ${SIMULATION_DISTANCE_PERCENTAGE_OF_VANILLA} -le 95 ]; then
    export MOB_SPAWN_RANGE=7
elif [ ${SIMULATION_DISTANCE_PERCENTAGE_OF_VANILLA} -le 100 ]; then
    export MOB_SPAWN_RANGE=8
fi
